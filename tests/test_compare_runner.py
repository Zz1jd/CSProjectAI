...
class CompareRunnerTests(unittest.TestCase):
    ...
    def test_run_compare_suite_records_both_rag_results_without_acceptance(
        self,
    ) -> None:
        ...
        model_spec = ModelSpec(
            model_name="gpt-3.5-turbo", result_label="repro_gpt_3_5_turbo_20260420"
        )
        baseline_run = mock.Mock(
            best=-1200.0,
            sample_lines=2,
            valid_eval_ratio=0.9,
            evals_per_sample=1.0,
            retrieval_events=0,
            retrieval_mean_top_score=None,
            retrieval_mean_top_score_gap=None,
            retrieval_mean_confidence=None,
            retrieval_mean_injected_chars=None,
            retrieval_mean_injected_sources=None,
            retrieval_mean_unique_sources=None,
            retrieval_multi_source_hit_rate=None,
            retrieval_skip_ratio=None,
        )
        rag_v32 = mock.Mock(
            best=-1190.0,
            sample_lines=2,
            ...
            evals_per_sample=1.0,
            retrieval_events=1,
            retrieval_mean_top_score=0.7,
            retrieval_mean_top_score_gap=0.2,
            retrieval_mean_confidence=0.2,
            retrieval_mean_injected_chars=420.0,
            retrieval_mean_injected_sources=1.0,
            retrieval_mean_unique_sources=1.0,
            retrieval_multi_source_hit_rate=0.0,
            retrieval_skip_ratio=0.0,
        )
        rag_v33 = mock.Mock(
            best=-1180.0,
            sample_lines=2,
            ...
            evals_per_sample=1.0,
            retrieval_events=1,
            retrieval_mean_top_score=0.8,
            retrieval_mean_top_score_gap=0.3,
            retrieval_mean_confidence=0.3,
            retrieval_mean_injected_chars=520.0,
            retrieval_mean_injected_sources=1.0,
            retrieval_mean_unique_sources=1.0,
            retrieval_multi_source_hit_rate=0.0,
            retrieval_skip_ratio=0.0,
        ...
        with mock.patch(
            ...
            return_value=(
                ...
                None,
                None,
                mock.Mock(return_value="20260425_010101"),
                None,
            ),
        ), mock.patch(
        ...
        self.assertEqual(
            summary["rag_runs"][0]["candidate"]["name"], "smoke_v32_dynamic_history"
        )
        self.assertEqual(
            summary["rag_runs"][1]["candidate"]["name"], "smoke_v33_full_corpus"
        )
        self.assertEqual(
            summary["best_rag"]["candidate"]["name"], "smoke_v33_full_corpus"
        )
    ...
    def test_run_single_rag_candidate_skips_baseline(self) -> None:
        ...
        with mock.patch(
            ...
            return_value=(
                ...
                None,
                None,
                mock.Mock(return_value="20260425_020202"),
                None,
            ),
        ), mock.patch(
            "scripts.run_rag_compare_repro_20260420_133019._resolve_results_dir",
            ...
            "scripts.run_rag_compare_repro_20260420_133019._run_rag_candidate",
            return_value=(
                Path("results/test_single/rag_smoke_v33_full_corpus.txt"),
                rag_run,
            ),
        ), mock.patch(
            "scripts.run_rag_compare_repro_20260420_133019._write_json",
